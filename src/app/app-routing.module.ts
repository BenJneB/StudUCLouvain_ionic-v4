...
const routes: Routes = [
  { path: '', redirectTo: 'home', pathMatch: 'full' },
    {path: 'course', loadChildren: './studies/course/course.module#CoursePageModule'},
  { path: 'credits', loadChildren: './pages/credit/credit.module#CreditPageModule' },
    {path: 'employee', loadChildren: './support/employee-details/employee-details.module#EmployeeDetailsPageModule'},
    {path: 'events', loadChildren: './events/events.module#EventsPageModule'},
    {path: 'events/details', loadChildren: './events/events-details/events-details.module#EventsDetailsPageModule'},
  ...
  {path: 'libraries/details', loadChildren: './libraries/library-details/library-details.module#LibraryDetailsPageModule'},
  { path: 'map', loadChildren: './pages/map/map.module#MapPageModule' },
  { path: 'mobility', loadChildren: './pages/mobility/mobility.module#MobilityPageModule' },
    {path: 'news', loadChildren: './news/news.module#NewsPageModule'},
    {path: 'news/details', loadChildren: './news/news-details/news-details.module#NewsDetailsPageModule'},
